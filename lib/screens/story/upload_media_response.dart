...
class Guid {
  ...
  Guid({required this.rendered, required this.raw});
...
class Meta {
  ...
  Meta({required this.pmproDefaultLevel});
...
class Sizes {
  ...
  Sizes(
      ...
      required this.m1536x1536,
      required this.m2048x2048,
      required this.postThumbnail,
      required this.kavaThumbS,
      required this.kavaThumbS2,
      required this.kavaThumbM,
      required this.kavaThumbMVertical,
      required this.kavaThumbM2,
      required this.kavaThumbL,
      required this.kavaThumbXl,
      required this.kavaThumbMasonry,
      required this.kavaThumbJustify,
      required this.kavaThumbJustify2,
      required this.full});
  ...
  Sizes.fromJson(Map<String, dynamic> json) {
    ...
    large = (json['large'] != null
        ? Medium.fromJson(json['large'] as Map<String, dynamic>)
        : null)!;
    ...
    kavaThumbJustify2 = (json['kava-thumb-justify-2'] != null
        ...
        : null)!;
    full = (json['full'] != null
        ? Medium.fromJson(json['full'] as Map<String, dynamic>)
        : null)!;
  }
...
class Links {
  ...
  Links({required this.self, required this.author, required this.curies});
