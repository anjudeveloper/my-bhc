...
class Links {
  Links({
   ...
   required  this.wpActionPublish,
   required  this.wpActionUnfilteredHtml,
   required  this.wpActionSticky,
   required  this.wpActionAssignAuthor,
   required  this.wpActionCreateCategories,
   required  this.wpActionAssignCategories,
   required  this.wpActionCreateTags,
   required  this.wpActionAssignTags,
