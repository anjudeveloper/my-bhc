...
class _SignInScreenState extends State<SignInScreen> {
        ...
        showAlertDialog(
            ...
            defaultFunc: () async {
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => WelcomeScreen(key: UniqueKey(),auth: auth)),
              );
              return;
            });
      }
  ...
  Future signIn() async {
    ...
    if (response != null) {
      ...
      Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => HomeScreen(auth: auth,)), (Route<dynamic> route) => false);
    } else {
      EasyLoading.dismiss();
    }
  }
