...
class SearchResultView extends StatefulWidget {
  SearchResultView({required this.dataList});
...
class _SearchResultViewState extends State<SearchResultView> {
  late List<LocalStoriesResponse> locallySavedStories;
  ScrollController _controller = ScrollController();

  late LocalStoriesResponse _localStoriesResponse;
    ...
    return Scaffold(
      ...
      body: Container(
        child: SingleChildScrollView(
          ...
          child: DetailWidget(list: dataList ?? SearchResponse()),
        ),
      ),
    );
